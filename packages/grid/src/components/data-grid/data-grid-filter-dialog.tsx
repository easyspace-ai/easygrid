...
export function DataGridFilterDialog<TData>({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] flex flex-col bg-white dark:bg-background">
        <DialogHeader>
...
function FilterConditionEditor({
  ...
  // const headerLabel = typeof column?.columnDef.header === "string" ? column.columnDef.header : condition.fieldId || "选择字段";
